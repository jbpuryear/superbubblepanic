...
SBP.states.Level = function() {
    return this;
}

SBP.states.Level.prototype = {
    init: function(map) {
    ...
    addPlayer: function(data) {
        var player = new SBP.objects.Player(this, data.x, data.y, 'player');
    ...
    addPistol: function(data) {
        ...
        var x = data.x || 0;
        var y = data.y || 0;
        return this._addGun(new SBP.objects.Pistol(this, x, y, 'gun', 'bullet'));
    },

    addEnemy: function(data) {
        var drop = this.parseDrop(data.properties.drop);
        var enemy = new SBP.objects.Enemy(this, data.x, data.y, 'enemy', data.width,
